mutable struct parms
    ...
    r_c_Hfac::Matrix  # heat rate factor (can be gt. 1)
    r_c_Helec::Matrix  # heat electrification fraction (can be gt. 1)
    ...
    r_c_Ufac::Matrix  # electricity increase factor (can be gt. 1)
    ...
    r_c_Fe::Matrix  # 32 fuel emission factor [f, k] (em u/fu u)
    ...
    n_c_UonSite::Array
    n_c_Ufac::Matrix  # electricity increase factor (can be gt. 1)
